...
var indexNav = [
    ...
    {
        name: '农产品供应商',
        url: './pages/gongyingshang/list.html'
    },
    {
        name: '农产品委托',
        url: './pages/nongchanpinweituo/list.html'
    },
    {
        name: '农产品物流公司',
        url: './pages/wuliugongsi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/nongchanpinzhihuiwuliu/admin/dist/index.html#/login";
