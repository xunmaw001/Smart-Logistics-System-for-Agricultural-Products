            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.gongyingshangId">
                            农产品供应商
                        </span>
                        ...
                        <span v-if="scope.row.wuliugongsiId">
                            农产品物流公司
                        </span>
                    </template>
                </el-table-column>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'gongyingshang' && scope.row.gongyingshangId ==userId)
|| (sessionTable == 'yonghu' && scope.row.yonghuId ==userId)
|| sessionTable == 'users'
|| (sessionTable == 'wuliugongsi' && scope.row.wuliugongsiId ==userId))" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除帖子</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="demo-input-suffix">
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '供应商姓名' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.gongyingshangName" placeholder="供应商姓名" clearable></el-input>
                    </el-form-item>
                                                                                 
                    <el-form-item :label="contents.inputTitle == 1 ? '供应商类型' : ''">
                        <el-select v-model="searchForm.gongyingshangTypes" placeholder="请选择供应商类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/nongchanpinzhihuiwuliu/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            <span v-if="scope.row.gongyingshangId">
                                <div v-if="scope.row.gongyingshangPhoto">
                                    <img :src="$base.url+scope.row.gongyingshangPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.yonghuId">
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.gongyingshangId = el.gongyingshangId;//---
                            forum.gongyingshangName = el.gongyingshangName;
                            forum.gongyingshangPhoto = el.gongyingshangPhoto;
                            forum.gongyingshangPhone = el.gongyingshangPhone;
                            forum.gongyingshangEmail = el.gongyingshangEmail;
                            forum.gongyingshangTypes = el.gongyingshangTypes;
                            forum.gongyingshangContent = el.gongyingshangContent;
                            forum.gongyingshangDelete = el.gongyingshangDelete;
                            forum.createTime = el.createTime;
                            forum.wuliugongsiId = el.wuliugongsiId;//---
                            forum.wuliugongsiName = el.wuliugongsiName;
                            forum.wuliugongsiPhoto = el.wuliugongsiPhoto;
                            forum.wuliugongsiPhone = el.wuliugongsiPhone;
                            forum.wuliugongsiEmail = el.wuliugongsiEmail;
                            forum.wuliugongsiTypes = el.wuliugongsiTypes;
                            forum.wuliugongsiContent = el.wuliugongsiContent;
                            forum.wuliugongsiDelete = el.wuliugongsiDelete;
                            forum.createTime = el.createTime;
