...
public class ForumEntity<T> implements Serializable {
     ...
     * 农产品供应商
     */
    @ColumnInfo(comment="农产品供应商",type="int(11)")
     ...
     * 农产品物流公司
     */
    @ColumnInfo(comment="农产品物流公司",type="int(11)")
    @TableField(value = "wuliugongsi_id")

    private Integer wuliugongsiId;
	 ...
	 * 获取：农产品物流公司
	 */
    public Integer getWuliugongsiId() {
        return wuliugongsiId;
    }
    /**
	 * 设置：农产品物流公司
	 */

    public void setWuliugongsiId(Integer wuliugongsiId) {
        this.wuliugongsiId = wuliugongsiId;
    }
    /**
	 * 获取：用户
	 */
